...
class Date_Time extends React.Component{
    constructor(){
        super()
        this.state={
            title:"",
    ...
    render(){
        return(
            ...
            <div className="col-sm-4">
             ...
             <br/>
             <TextField variant="standard" margin ="normal" fullWidth  type="text" name="type" placeholder="DATE|TIME|DATE-TIME" onChange={this.handleChange}/>
             <br/>
             <TextField variant="standard" margin ="normal" fullWidth  type="text" name="format" placeholder="dd/mm/yy" onChange={this.handleChange}/>
             <br/>
